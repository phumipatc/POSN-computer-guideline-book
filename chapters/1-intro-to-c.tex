...
\section{ข้อมูลนำเข้า/ข้อมูลส่งออก}
...
นอกจากนี้ยังมีการวนซำ้แบบ \textbf{\texttt{do-while}} ซึ่งจะทำงานก่อน 1 รอบไม่ว่าเงื่อนไขที่กำหนดจะเป็นจริงหรือไม่ แล้วจึงตรวจสอบเงื่อนไขก่อนทำงานรอบถัดไป
\begin{example}
